  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center relative pt-20 pb-32">
      ...
      >
        ...
        >
          Je conçois des sites web professionnels qui captent l'attention, instaurent une confiance immédiate et valorisent enfin votre savoir-faire auprès de vos clients actuels et futurs.
        </motion.p>

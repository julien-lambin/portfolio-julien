...
export const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-24 overflow-hidden relative bg-slate-50/50 dark:bg-slate-950/50">
      <motion.div 
      ...
      >
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-lg">
          J'utilise les meilleures technologies actuelles pour vous garantir un site performant et sécurisé.
        </p>
      </motion.div>
